...
import 'package:fruit_ninja_game/components/back_button.dart';
import 'package:fruit_ninja_game/components/fruit_component.dart';
import 'package:fruit_ninja_game/components/pause_button.dart';
    ...
    if (!_countdownFinished) {
      ...
      fruitsTime.where((element) => element < time).toList().forEach((element) {
        ...
        add(FruitComponent(
          this,
          fruitPosition,
          acceleration: AppConfig.accleration,
          fruit: randFruit,
